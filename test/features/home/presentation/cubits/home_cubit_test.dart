...
import 'package:rppay/features/home/presentation/cubits/home_cubit.dart';
import 'package:rppay/features/home/presentation/cubits/home_state.dart';
import 'package:rppay/features/home/domain/entities/home_data_entity.dart';
import 'package:rppay/features/home/domain/repositories/home_repository.dart';
...
void main() {
  ...
  group('HomeCubit', () {
    ...
    blocTest<HomeCubit, HomeState>(
      ...
      build: () =>
          HomeCubit(repository: _FakeHomeRepository(items: const [item])),
